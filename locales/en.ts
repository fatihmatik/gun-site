...
export default {
  ...
  servicesPage: {
    ...
    service1: {
      h2: "Visa Consultancy",
      p: "We offer expert guidance on visa applications for undergraduate and master's programs in Italy, ensuring a smooth process from start to finish.",
    },
    service2: {
